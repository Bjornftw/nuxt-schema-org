...
The module exposes the officially supported nodes from [Unhead Schema.org]([https://unhead.unjs.io/schema-org/schema](https://unhead.unjs.io/docs/typescript/schema-org/api/composables/use-schema-org)). Official nodes
